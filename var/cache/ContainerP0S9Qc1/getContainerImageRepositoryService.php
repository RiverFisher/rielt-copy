...
// Returns the private 'App\Repository\Platform\ContainerImageRepository' shared autowired service.
...
include_once $this->targetDirs[2].'/src/Repository/Platform/ContainerImageRepository.php';

return $this->privates['App\Repository\Platform\ContainerImageRepository'] = new \App\Repository\Platform\ContainerImageRepository(($this->services['doctrine'] ?? $this->getDoctrineService()));
