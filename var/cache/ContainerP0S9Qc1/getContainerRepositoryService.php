...
// Returns the private 'App\Repository\Platform\ContainerRepository' shared autowired service.
...
include_once $this->targetDirs[2].'/src/Repository/Platform/ContainerRepository.php';

return $this->privates['App\Repository\Platform\ContainerRepository'] = new \App\Repository\Platform\ContainerRepository(($this->services['doctrine'] ?? $this->getDoctrineService()));
