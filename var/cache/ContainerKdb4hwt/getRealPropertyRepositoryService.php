...
// Returns the private 'App\Repository\RealProperty\RealPropertyRepository' shared autowired service.
...
include_once $this->targetDirs[2].'/src/Repository/RealProperty/RealPropertyRepository.php';

return $this->privates['App\Repository\RealProperty\RealPropertyRepository'] = new \App\Repository\RealProperty\RealPropertyRepository(($this->services['doctrine'] ?? $this->getDoctrineService()));
