...
include_once $this->targetDirs[2].'/vendor/vich/uploader-bundle/EventListener/Doctrine/InjectListener.php';
...
$g->addEventSubscriber(new \Vich\UploaderBundle\EventListener\Doctrine\InjectListener('image', $f, $a, $b));
