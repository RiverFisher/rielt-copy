...
// Returns the private 'App\Repository\RealProperty\RealPropertyTypeRepository' shared autowired service.
...
include_once $this->targetDirs[2].'/src/Repository/RealProperty/RealPropertyTypeRepository.php';

return $this->privates['App\Repository\RealProperty\RealPropertyTypeRepository'] = new \App\Repository\RealProperty\RealPropertyTypeRepository(($this->services['doctrine'] ?? $this->getDoctrineService()));
