...
// Returns the private 'App\Repository\Platform\ImageRepository' shared autowired service.
...
include_once $this->targetDirs[3].'/src/Repository/Platform/ImageRepository.php';

return $this->privates['App\Repository\Platform\ImageRepository'] = new \App\Repository\Platform\ImageRepository(($this->services['doctrine'] ?? $this->getDoctrineService()));
